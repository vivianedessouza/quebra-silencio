      ...
      <div className="external--container">
           ...
           <div className="main--section">
              ...
              <p className="steps">Passo 3 de 3</p>
                ...
                <input type="text" name="image" id="image" className="state--input" placeholder="Upload - Foto de Perfil (Opcional)"/>
                <p className="information">Informação de que a conta ficará pendente até os documentação ficar aprovada</p>
