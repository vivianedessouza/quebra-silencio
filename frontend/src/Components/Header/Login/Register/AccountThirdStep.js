...
export class AccountThirdStep extends Component {
  render() {
    return (
 ...
 <div class="main--section">
      ...
      <textarea className="situation--description">Descreva a sua situação… Esta informação estará visível apenas para profissionais que a possam ajudar</textarea>
      <input type="text" name="state" className="state--input" placeholder="Estado Civil"/>
